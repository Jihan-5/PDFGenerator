...
export const PlayStoreIcon: React.FC = () => (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M3.1,2.5l9.2,9.2L3.1,20.8c-0.6-0.3-1-1-1-1.7V4.2C2.1,3.5,2.5,2.8,3.1,2.5z M4.6,22.1l11.7-6.7l-4.5-4.5L4.6,22.1z M20.9,10.1l-4.5,4.5l-7.2-7.2l7.2-7.2C17.3,0,18.5,0.2,19.5,1l-6.8,6.8l8.2,4.7C21.1,11.8,21.1,10.8,20.9,10.1z M13.1,12.3l4.5-4.5l-11.7-6.7C5.6,1,5.3,1,5,1.1L13.1,12.3z"/>
    </svg>
);
...
export const ImpactIconUp: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={`w-4 h-4 text-green-600 ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const ImpactIconNeutral: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={`w-4 h-4 text-gray-500 ${className}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const TelegramIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className}>
        ...
        <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0zm5.143 8.24l-1.437 6.685c-.15 1.034-.632 1.29-1.51 0.784l-2.074-1.524-1.008 1.023c-.112.112-.224.224-.448.224l.15-2.115 3.99-3.623c.335-.336-.057-.504-.492-.168L7.04 13.99l-2.02-.63c-1.012-.326-1.023-1.023.203-1.53l11.16-4.364c.895-.336 1.647.203 1.343.999z"/>
    </svg>
);
...
const WhatsAppIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className}>
        ...
        <path d="M12.04 2.02c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.42 1.29 4.88L2 22l5.25-1.38c1.41.78 3.02 1.21 4.79 1.21h.01c5.46 0 9.91-4.45 9.91-9.91s-4.45-9.91-9.91-9.91zM12.05 3.6c4.54 0 8.23 3.69 8.23 8.23s-3.69 8.23-8.23 8.23h-.01c-1.54 0-3.03-.42-4.31-1.18l-.31-.18-3.21.84.86-3.13-.2-.32c-.82-1.32-1.28-2.85-1.28-4.45 0-4.54 3.69-8.23 8.23-8.23zm4.52 10.2c-.25-.12-1.47-.72-1.7-.8s-.39-.12-.56.12c-.17.25-.64.8-.79.96-.15.17-.3.19-.56.06s-1.06-.39-2.02-1.25c-.75-.67-1.25-1.49-1.4-1.75-.14-.25-.02-.38.11-.51.11-.11.25-.29.37-.43.13-.14.17-.25.25-.41.08-.17.04-.31-.02-.43s-.56-1.34-.76-1.84c-.2-.48-.41-.42-.56-.42h-.48c-.17 0-.43.06-.66.31s-.86.84-.86 2.05c0 1.21.88 2.37 1 2.53s1.75 2.66 4.24 3.73c.59.25 1.05.4 1.41.51.58.19 1.11.16 1.52.1.48-.07 1.47-.6 1.67-1.18s.21-1.09.18-1.18c-.04-.08-.14-.13-.25-.25z"/>
    </svg>
);

const SocialIcon: React.FC<{ children: React.ReactNode, bgColor: string, hoverColor: string }> = ({ children, bgColor, hoverColor }) => (
    <a href="#" className={`w-8 h-8 ${bgColor} ${hoverColor} text-white flex items-center justify-center rounded-full cursor-pointer transition-colors p-1.5`}>
        {children}
    </a>
);
...
export const CandleStickChartSVG = () => (
    <svg width="100%" height="160" viewBox="0 0 400 160" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Grid lines */}
        <line x1="0" y1="32" x2="400" y2="32" stroke="#E5E7EB" strokeWidth="0.5"/>
        <line x1="0" y1="64" x2="400" y2="64" stroke="#E5E7EB" strokeWidth="0.5"/>
        <line x1="0" y1="96" x2="400" y2="96" stroke="#E5E7EB" strokeWidth="0.5"/>
        <line x1="0" y1="128" x2="400" y2="128" stroke="#E5E7EB" strokeWidth="0.5"/>
        {/* Moving Averages */}
        <path d="M 20 80 C 80 72, 150 96, 220 88 S 350 112, 380 104" stroke="#D69E2E" fill="none" strokeWidth="1.5"/>
        <path d="M 20 104 C 80 96, 150 120, 220 112 S 350 136, 380 128" stroke="#4A5568" fill="none" strokeWidth="1.5" strokeDasharray="4 2"/>
        {/* Candlesticks */}
        <line x1="30" y1="72" x2="30" y2="96" stroke="#E53E3E" strokeWidth="1"/>
        <rect x="25" y="80" width="10" height="12" fill="#E53E3E"/>
        <line x1="50" y1="64" x2="50" y2="84" stroke="#38A169" strokeWidth="1"/>
        <rect x="45" y="68" width="10" height="12" fill="#38A169"/>
        <line x1="70" y1="76" x2="70" y2="100" stroke="#38A169" strokeWidth="1"/>
        <rect x="65" y="80" width="10" height="16" fill="#38A169"/>
        <line x1="90" y1="88" x2="90" y2="112" stroke="#E53E3E" strokeWidth="1"/>
        <rect x="85" y="96" width="10" height="12" fill="#E53E3E"/>
        <line x1="280" y1="48" x2="280" y2="72" stroke="#38A169" strokeWidth="1"/>
        <rect x="275" y="52" width="10" height="16" fill="#38A169"/>
        <line x1="300" y1="40" x2="300" y2="64" stroke="#E53E3E" strokeWidth="1"/>
        <rect x="295" y="48" width="10" height="12" fill="#E53E3E"/>
        <line x1="320" y1="56" x2="320" y2="80" stroke="#38A169" strokeWidth="1"/>
        <rect x="315" y="60" width="10" height="16" fill="#38A169"/>
        <line x1="340" y1="64" x2="340" y2="88" stroke="#E53E3E" strokeWidth="1"/>
        <rect x="335" y="72" width="10" height="12" fill="#E53E3E"/>
        <line x1="360" y1="76" x2="360" y2="100" stroke="#38A169" strokeWidth="1"/>
        <rect x="355" y="80" width="10" height="16" fill="#38A169"/>
        {/* Axis Labels */}
        <text x="385" y="34" fill="#718096" fontSize="8">25600</text>
        <text x="385" y="66" fill="#718096" fontSize="8">25200</text>
        <text x="385" y="98" fill="#718096" fontSize="8">24800</text>
        <text x="385" y="130" fill="#718096" fontSize="8">24400</text>
    </svg>
);
...
export const Header: React.FC = () => (
    <div className="header">
        <div className="header-logo-section">
            <NuqiEthosphereLogo className="header-logo" />
            <span className="header-company-name">NUQI ETHOSPHERE</span>
        </div>
        <h1 className="header-title">Daily News</h1>
    </div>
);

export const Footer: React.FC = () => (
    <div className="footer">
        <p>Source: Bloomberg, NSE, NSDL, BSE, Nuqi Ethosphere Research</p>
        <p>Data sourced from internal database.</p>
    </div>
);
